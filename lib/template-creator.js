...
class TemplateCreator {
  ...
  _getRenamedCode(fileSource) {
    ...
    try {
      ...
      result = fileSource.replace(tempNameReg, `$1${this._getComponentName()}$2`);
      ...
      result = fileSource.replace(tempConstructorNameReg, `$1${this._getConstructorName()}$2`);
      ...
      result = fileSource.replace(tempCssComponentNameReg, `$1${this._getCssComponentName()}$2`);
